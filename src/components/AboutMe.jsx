...
const AboutMe = () => {
    return (<div className="aboutme-wrapper">
        ...
        <div className="text-wrapper">
            ...
            &nbsp;leading me to pursue further opportunities in the field. Driven to learn and develop my skills as a software engineer, I hope to use the insight and knowledge from my local peers to continue my growth through through self learning and motivation. 
